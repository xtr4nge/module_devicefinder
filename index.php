...
<div class="rounded-bottom">
	...
	<form action="index.php" method="POST">
		...
		<select class="input" onchange="this.form.submit()" name="ss_iface" <? if ($ismoduleup != "") echo "disabled" ?> >
        <option>-</option>
			<?
                ...
                <form action="index.php" method="POST" autocomplete="off">				
                    <table>
                        <tr>
                            ...
                            <td>
								<input class="input" name="macaddress" value="<?=$mod_macaddress?>">
								<input type="radio" name="ss_mode" value="1" <? if ($mod_mode == "1") echo "checked" ?> >
							</td>
                        </tr>
						<tr>
                            <td align="right">essid: </td>
                            <td>
								<input class="input" name="essid" value="<?=$mod_essid?>">
								<input type="radio" name="ss_mode" value="2" <? if ($mod_mode == "2") echo "checked" ?> >
							</td>
                        </tr>
                        <tr>
                            <td></td>
